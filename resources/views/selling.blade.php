    ...
    <section>
        <div class="container">
            <div id="outContainer" style="width:100%;">
                ...
                <table id="example" class="text-center table table-bordered table-striped table-hover bookshell"
                    ...
                    @isset($userSell)
                        @foreach ($userSell as $sell)
                            <tr>
                                ...
                                <td scope="col">{{ $sell->game_price }}</td>
                                ...
                                @if($sell->status == "unsold")
                                <td>
                                    <a href="{{ route('cancelsell') }}?sell_id={{ $sell->id }}"
                                        class='btn  btn-primary'>Cancel Sell</a>
                                </td>
                                @else
                                <th class="text-center" scope="col">It is Sold</th>
