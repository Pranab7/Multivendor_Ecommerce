                    ...
                    <tbody>
                        ...
                        @isset($userSell)
                            @foreach ($userSell as $sell)
                                <tr>
                                    <td scope="col">{{ App\Models\User::where('id', $sell->user_id)->first()->name }}
                                    </td>
                                    <td scope="col">
                                        {{ $sell->user_id }}
                                    </td>
                                    <td scope="col">
                                        {{ App\Models\User::where('id', $sell->user_id)->first()->email }}
                                    </td>
                                    <td scope="col">
                                        {{ @App\Models\UserContact::where('user_id', $sell->user_id)->first()->phone_no & null }}
                                    </td>
                                    <td scope="col">
                                        {{ $sell->game_name }}
                                    </td>
                                    ...
                                    <td scope="col">
                                        <a href="{{ route('cancelselladmin') }}?sell_id={{ $sell->id }}"
                                            class='btn  btn-primary'>Cancel Sell</a>
                                    </td>
                                </tr>
                            @endforeach
                        @endisset
