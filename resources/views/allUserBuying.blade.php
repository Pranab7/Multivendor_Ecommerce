        ...
        <nav class="navbar navbar-default">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ route('home') }}"><img src="image/logo.png"
                            class="img-responsive" width="30%" h alt="Logo"></a>
                </div>
    ...
    <section>
        <div class="container">
            <div id="outContainer" style="width:100%;">
                <h4 class="text-center text-black pt-2"><strong>Buyer</strong></h4>
                <hr>

                <table id="example" class="table table-bordered table-striped table-hover bookshell" style="width:100%;"
                    align="center">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @isset($userCart)
                            @foreach ($userCart as $cart)
                                <tr>
                                    <td scope="col">{{ $cart->buyer_name }}</td>
                                    <td scope="col">{{ $cart->buyer_id }}</td>
                                    <td scope="col">
                                        {{ App\Models\User::where('id', $cart->buyer_id)->first()->email }}
                                    </td>
                                    <td scope="col">
                                        {{ App\Models\UserContact::where('user_id', $cart->buyer_id)->first()->phone_no }}
                                    </td>
                                    <td scope="col">
                                        {{ $cart->game_name }}
                                    </td>
                                    ...
                                    <td scope="col">
                                        <a href="{{ route('cancel') }}?cart_id={{ $cart->id }}&post_id={{ $cart->game_id }}"
                                            class='btn btn-primary' style="margin: 2px">Cancel</a>
                                    </td>
                                </tr>
                            @endforeach
                        @endisset
