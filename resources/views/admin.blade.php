        ...
        <nav class="navbar navbar-default">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="Main_index.html"><img src="image/logo.png" class="img-responsive"
                            width="30%" h alt="Logo"></a>
                </div>
              ...
              <ul class="dropdown-menu animated zoomIn">
                ...
                <li><a href="#" target="_blank"> 404 </a></li>
                        ...
                        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                                role="button" aria-haspopup="true" aria-expanded="false">Orders<span
                                    class="caret"></span></a>
                            <ul class="dropdown-menu animated zoomIn">
                        ...
                        @if (Auth::user())
                            ...
                            <li>
                                <img class="profile-picture" @if (empty($userInfo))
        ...
        <div class="card-group">
            @foreach ($userPost as $post)
                <div class="card" style="margin: 30px 0px;">
                    <img class="card-img-top" src="{{ asset('storage') }}/{{ $post->game_image }}"
                        alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-1">
                    <div class="left-user12923 left-user12923-repeat">
                        <a href="#"><img src="image/images.png" alt="image"> </a> <a href="#"><i class="fa fa-check"
                    ...
                    <div class="right-description893">
                        ...
                        <div class="ques-details10018">
                            <p>Duis dapibus aliquam mi, eget euismod sem scelerisque ut. Vivamus at elit quis urna
                                adipiscing iaculis.Duis dapibus aliquam mi, eget euismod sem scelerisque ut. Vivamus at
                                elit quis urna adipiscing iaculis.</p>
                        </div>
                        <hr>
                        <div class="ques-icon-info3293"> <a href="#"><i class="fa fa-star" aria-hidden="true"> 5
                                </i> </a> <a href="#"><i class="fa fa-folder" aria-hidden="true"> Price</i></a> <a
                                href="#"><i class="fa fa-clock-o" aria-hidden="true"> 4 min ago</i></a> <a href="#"><i
                ...
                <div class="col-md-2">
                    <div class="ques-type302">
                        <a href="#">
                            <button type="button" class="q-type238"><i class="fa fa-comment" aria-hidden="true">
                                    33 interested</i></button>
                        </a>
                        <a href="#">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="info-part-one320">
                        <h4>About us ?</h4>
                        <p class="mb-0">Our platform offers marketplaces to provide buyers and sellers with
                            hassle-free trading for game accounts.</p>
                        <h4>Address :</h4>
